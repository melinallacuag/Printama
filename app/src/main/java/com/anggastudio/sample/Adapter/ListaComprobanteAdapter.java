...
public class ListaComprobanteAdapter  extends RecyclerView.Adapter<ListaComprobanteAdapter.ViewHolder>{
    ...
    final ListaComprobanteAdapter.OnItemClickListener listener;
    ...
    public ListaComprobanteAdapter(List<ListaComprobante> listaComprobanteList, Context context,ListaComprobanteAdapter.OnItemClickListener listener){
